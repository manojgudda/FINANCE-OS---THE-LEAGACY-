...
SECRET_KEY = 'django-insecure-development-key-change-this-later'
...
TEMPLATES = [
    {
        ...
        'DIRS': [], # Django will automatically look in your app's 'templates' folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# 1. Default SQLite for Django's built-in Admin, Auth, and Sessions
DATABASES = {
    'default': {
